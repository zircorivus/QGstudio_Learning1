...
private:
    ...
    ComPtr<ID3D11ShaderResourceView> m_pTextureSRV; // 纹理数据
    ComPtr<ID3D11SamplerState> m_pSamplerState; // 纹理采样方式
    ...
    ComPtr<ID3D11BlendState> BSTransparent; // 半透明的混合模式
    ComPtr<ID3D11RasterizerState> RSNoCull; // 不进行背面剔除
