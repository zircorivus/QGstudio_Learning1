...
void GameApp::UpdateScene(float dt)
{
    ...
    XMMATRIX R = XMMatrixRotationY(0.0f) * XMMatrixRotationZ(phi);
...
bool GameApp::InitEffect()
{
    ...
    // 创建顶点着色器
    HR(CreateShaderFromFile(L"HLSL\\work3_TEX_VS.cso", L"HLSL\\work3_TEX_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
    ...
    // 创建像素着色器
    HR(CreateShaderFromFile(L"HLSL\\work3_TEX_PS.cso", L"HLSL\\work3_TEX_PS.hlsl", "PS", "ps_5_0", blob.ReleaseAndGetAddressOf()));
...
bool GameApp::InitResource()
{
    ...
    HR(CreateWICTextureFromFile(m_pd3dDevice.Get(), L"Texture\\ENDFIELD_SHARE_1773676907.png", nullptr, m_pTextureSRV.GetAddressOf()));
