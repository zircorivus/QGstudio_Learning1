...
bool GameApp::InitEffect()
{
    ...
    // 创建顶点着色器
    HR(CreateShaderFromFile(L"HLSL\\work4_Light_VS.cso", L"HLSL\\work4_Light_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
    ...
    // 创建像素着色器
    HR(CreateShaderFromFile(L"HLSL\\work4_Light_PS.cso", L"HLSL\\work4_Light_PS.hlsl", "PS", "ps_5_0", blob.ReleaseAndGetAddressOf()));
